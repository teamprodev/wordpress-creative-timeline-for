...
(function($) {
  ...
  function CTWPAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  CTWPAjaxChosen.prototype.init = function() {
  ...
  CTWPAjaxChosen.prototype.events = function() {
    var _this = this;
  ...
  CTWPAjaxChosen.prototype.search_field_focused = function() {
  ...
  CTWPAjaxChosen.prototype.search_welcome_message = function() {
  ...
  CTWPAjaxChosen.prototype.update_list = function() {
    var _this = this;
    this.search_welcome_message();
    ...
    this.timer = setTimeout(function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('ctwp-chosen', _this.options.data).done(function(response) {
  ...
  CTWPAjaxChosen.prototype.show_results = function(items) {
    var _this = this;
    ...
    if(this.is_multiple) {
      var $hidden_select = this.element.parent().find('.ctwp-hide-select');
      var $hidden_value  = $hidden_select.val() || [];
      this.element.CTWPChosenOrder($hidden_value, true);
  ...
  $.fn.CTWPAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new CTWPAjaxChosen(this, chosenOptions);
    });
  };
...
;
(function() {
  var $, CTWPAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  CTWPAbstractChosenOrder = (function() {

    function CTWPAbstractChosenOrder() {}
    CTWPAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    CTWPAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    CTWPAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    CTWPAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    CTWPAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    CTWPAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    CTWPAbstractChosenOrder.CTWPChosenOrder = function(select, order, force) {
    ...
    return CTWPAbstractChosenOrder;
  })();

  $ = jQuery;
  $.fn.extend({
    CTWPChosenOrder: function(order, force) {
      return _CTWPChosenOrder.CTWPChosenOrder(this, order, force);
    }
  });

  this._CTWPChosenOrder = (function(_super) {
    __extends(_CTWPChosenOrder, _super);
    function _CTWPChosenOrder() {
      _ref = _CTWPChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _CTWPChosenOrder.relAttributeName = 'data-option-array-index';

    _CTWPChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _CTWPChosenOrder.getDOMElement = function(element) {
    ...
    _CTWPChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _CTWPChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };
    return _CTWPChosenOrder;
  })(CTWPAbstractChosenOrder);
}).call(this);
;(function() {
    ...
    applyRule: function(context, enforced) {
      ...
      if(result) {
        ...
        $(controls).each(function() {
          $(this).removeClass('ctwp-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectCTWP = FormSerializer.serializeObject;
    $.fn.serializeJSONCTWP   = FormSerializer.serializeJSON;
  }
