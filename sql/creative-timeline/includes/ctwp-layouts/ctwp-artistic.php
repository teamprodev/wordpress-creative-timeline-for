...
/**
 * 
 * Artistic Timeline Style + Options
 * 
 * @since 1.0.0
 * @version 1.0.0
 * 
...
$ctwp_post_category = $attribute['category'];
...
if ($ctwp_loop->have_posts()) { ?>	
    ...
    <div class="ctwp-artistic artistic-changing-<?php echo esc_attr(get_the_ID());?> <?php  echo esc_attr($ctwp_animation); ?>" data-id="<?php echo esc_attr($ctwp_animation); ?>">
        <?php
            ...
            <div class="ctwp-entry" id="<?php echo esc_attr('ctwp-'.get_the_ID());?>">
                <div class="ctwp-entry-inner">
                    <div class="ctwp-data-container">
                        <?php if($ctwp_post_image_on_off) { ?>
                            <div class="ctwp-featured-img-container">								
                        ...
                        <div class="ctwp-featured-container">
                            <div class="ctwp-categories-container">
                                <?php if($ctwp_post_cat_on_off) { ?>
									<?php 
                                    if($ctwp_post_category == '') { 
									$terms = get_the_terms($post->ID , 'ctwp_category');
                                    if (is_array($terms) || is_object($terms)) {
                                        foreach ($terms as $term) { 
                                            $ctwp_post_category_link = get_category_link($term->term_id); ?>
                                            <span class="ctwp-categories"><a href="<?php echo esc_url($ctwp_post_category_link); ?>"><?php esc_html_e($term->name); ?></a></span>
                                <?php } } } } ?>
                            </div>
                            <div class="ctwp-meta-date-container">
                                <?php if($ctwp_post_date_on_off) { 
                                    ...
                                    if(!empty($posted_date)) { ?>
                                        <div class="ctwp-meta-date">
                                            <span class="post-date"><i class="fa fa-calendar" aria-hidden="true"></i><?php echo esc_html($posted_date); ?></span>
                                        </div>
                                    <?php }
                                    else { ?>
                                        <div class="ctwp-meta-date">
                            ...
                            <?php } ?>
                            <div class="ctwp-tag-meta-container">
...
<?php } else {
    ...
    $ctwp_html_no_cont .= esc_html__('Sorry, you have not added any story yet', CTWP_DOMAIN);
    $ctwp_html_no_cont .= '</h4></div>';
} ?>
<style>
.ctwp-avatar-row .ctwp-heading, .ctwp-avatar-row .ctwp-avatar-container { 
    <?php esc_attr_e($ctwp_main_title_typo); ?>
    color:<?php esc_attr_e($ctwp_timeline_title_color); ?>;
}	
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-entry {
    border-bottom:1px solid <?php esc_attr_e($ctwp_timeline_color); ?>;
}
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-title{
	<?php esc_attr_e($ctwp_post_title_typo); ?>	
}
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-title a{
    color:<?php esc_attr_e($ctwp_post_title_color); ?>;
}
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-title a:hover{	
	color:<?php esc_attr_e($ctwp_post_title_hover_color); ?>;
}
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-content{
	<?php esc_attr_e($ctwp_post_content_typo); ?>
	color:<?php esc_attr_e($ctwp_post_content_color); ?>
}
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .post-date, .ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-meta-date{
	<?php esc_attr_e($ctwp_post_date_typo); ?>	
	color:<?php esc_attr_e($ctwp_post_date_color);?>
}
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .post-date:hover{
	color:<?php esc_attr_e($ctwp_post_date_hover_color);?>
}
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-meta.author, .ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-meta.author a,.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-meta.comment,.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-meta.comment a{
	<?php esc_attr_e($ctwp_post_meta_typo); ?>	
	color:<?php esc_attr_e($ctwp_post_meta_color); ?>
}
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-meta.author:hover, .ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-meta.author a:hover,.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-meta.comment:hover,.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-meta.comment a:hover{
	color:<?php esc_attr_e($ctwp_post_meta_hover_color); ?>
}
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-read-more{
	<?php esc_attr_e($ctwp_post_readmore_btn_typo); ?>	
}
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-entry .ctwp-entry-inner .ctwp-data-container  {
    background-color:<?php esc_attr_e($ctwp_post_content_box_color); ?>;
}
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-social-share a{
    color:<?php esc_attr_e($ctwp_post_social_color); ?>;
}
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-social-share a:hover{
    color:<?php esc_attr_e($ctwp_post_social_hover_color); ?>;
}
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-read-more a{
    color:<?php esc_attr_e($ctwp_post_readmore_btn_color); ?>;
	background-color:<?php esc_attr_e($ctwp_post_readmore_btn_bg_color); ?>;
}
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-read-more a:hover{
...
.ctwp-artistic.artistic-changing-<?php echo esc_attr(get_the_ID());?> .ctwp-categories {
